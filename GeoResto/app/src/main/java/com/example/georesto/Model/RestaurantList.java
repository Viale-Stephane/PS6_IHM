...
public class RestaurantList {
    ...
    public void sampleRestaurant(Context context) {
        ...
        Restaurant ilRistorante = new Restaurant("IL RISTORANTE", true, "50 voie Marie Fisher, Centre commercial Olympie, 06160 Antibes", "http://www.ilristorante.fr", "0422000150", schedule1, 3.2, 5, new ArrayList<>(Arrays.asList(Tag.Italien, Tag.Fromage)), new LatLng(43.599730, 7.085336), bitmap);
        Restaurant laCiteDOr = new Restaurant("La Cité d'or", true, "172 Avenue Weisweiller, 06600 Antibes", "http://restaurantlacitedor.com", "0422000150", schedule1, 1.2, 19, new ArrayList<>(Arrays.asList(Tag.Chinois, Tag.Viande, Tag.FastFood)), new LatLng(43.597924, 7.084902), bitmap);
