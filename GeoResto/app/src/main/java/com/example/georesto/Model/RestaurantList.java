...
public class RestaurantList {
    ...
    public void sampleRestaurant(Context context) {
        String[] schedule1 = {"de 08:30 à 22:00", "de 08:30 à 22:00", "de 08:30 à 22:00", "de 08:30 à 22:00", "de 08:30 à 22:00", "de 08:30 à 22:00", "de 08:30 à 12:30"};
        ...
        Restaurant burgerKing = new Restaurant("BurgerKing", true, "36 avenue Weisweiller, Angle Route De Grasse, 06600 Antibes", "http://www.bkvousecoute.fr", "0422000150", schedule2, 3.2, 15, new ArrayList<>(Arrays.asList(Tag.Burger, Tag.FastFood)), new LatLng(43.599070, 7.085523), BitmapFactory.decodeResource(context.getResources(), R.drawable.burgerking));
        Restaurant mcDonaldS = new Restaurant("McDonald's", true, "1990 Route de Grasse, 06600 Antibes", "http://www.mcdonalds.fr", "0492910000", schedule2, 4.4, 50, new ArrayList<>(Arrays.asList(Tag.Burger, Tag.Fromage, Tag.FastFood)), new LatLng(43.599959, 7.086446), BitmapFactory.decodeResource(context.getResources(), R.drawable.mcdonald));
        Restaurant ilRistorante = new Restaurant("IL RISTORANTE", true, "50 voie Marie Fisher, Centre commercial Olympie, 06160 Antibes", "http://www.ilristorante.fr", "0422000150", schedule3, 3.2, 5, new ArrayList<>(Arrays.asList(Tag.Italien, Tag.Fromage)), new LatLng(43.599730, 7.085336), BitmapFactory.decodeResource(context.getResources(), R.drawable.ilrestorante));
        Restaurant laCiteDOr = new Restaurant("La Cité d'or", true, "172 Avenue Weisweiller, 06600 Antibes", "http://restaurantlacitedor.com", "0422000150", schedule3, 1.2, 19, new ArrayList<>(Arrays.asList(Tag.Chinois, Tag.Viande, Tag.FastFood)), new LatLng(43.597924, 7.084902), BitmapFactory.decodeResource(context.getResources(), R.drawable.citedor));
        Restaurant carrefourAntibes = new Restaurant("Carrefour", false, "Chemin de Saint-Claude, 06600 Antibes", "http://www.carrefour.fr", "0682392412", schedule1, 4.2, 3, new ArrayList<>(Arrays.asList(Tag.Francais, Tag.FastFood, Tag.Healthy)), new LatLng(43.603813, 7.089160), BitmapFactory.decodeResource(context.getResources(), R.drawable.carrefour));
