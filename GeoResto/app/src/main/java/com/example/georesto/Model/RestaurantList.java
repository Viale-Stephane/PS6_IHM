...
public class RestaurantList {
    ...
    public void sampleRestaurant(Context context) {
        ...
        Restaurant burgerKing = new Restaurant("BurgerKing", true, "36 avenue Weisweiller, Angle Route De Grasse, 06600 Antibes", "www.bkvousecoute.fr", "0422000150", schedule2, 3.2, 15, new ArrayList<>(Arrays.asList(Tag.Burger, Tag.FastFood)), new LatLng(43.599070, 7.085523), bitmap);
        Restaurant mcDonaldS = new Restaurant("McDonald's", true, "1990 Route de Grasse, 06600 Antibes", "www.mcdonalds.fr", "https://www.mcdonalds.fr/", schedule2, 4.4, 50, new ArrayList<>(Arrays.asList(Tag.Burger, Tag.Fromage, Tag.FastFood)), new LatLng(43.599959, 7.086446), bitmap);
        Restaurant ilRistorante = new Restaurant("IL RISTORANTE", true, "50 voie Marie Fisher, Centre commercial Olympie, 06160 Antibes", "www.ilristorante.fr", "0422000150", schedule1, 3.2, 5, new ArrayList<>(Arrays.asList(Tag.Italien, Tag.Fromage)), new LatLng(43.599730, 7.085336), bitmap);
        Restaurant laCiteDOr = new Restaurant("La Cité d'or", true, "172 Avenue Weisweiller, 06600 Antibes", "citéd'or.fr", "0422000150", schedule1, 1.2, 19, new ArrayList<>(Arrays.asList(Tag.Chinois, Tag.Viande, Tag.FastFood)), new LatLng(43.597924, 7.084902), bitmap);
        Restaurant carrefourAntibes = new Restaurant("Carrefour", false, "Chemin de Saint-Claude, 06600 Antibes", "www.carrefour.fr", "0682392412", schedule1, 4.2, 3, new ArrayList<>(Arrays.asList(Tag.Francais, Tag.FastFood, Tag.Healthy)), new LatLng(43.603813, 7.089160), bitmap);
        Restaurant casinoSophia = new Restaurant("Casino", false, "St Philippe II, Avenue Roumanille, 06410 Biot", "magasins.supercasino.fr/supermarche/biot/CM898", "0497153030", schedule1, 3.9, 5, new ArrayList<>(Arrays.asList(Tag.Francais, Tag.FastFood, Tag.Healthy,Tag.Fromage)), new LatLng(43.617340, 7.074475), BitmapFactory.decodeResource(context.getResources(), R.drawable.casinotem));
        ...
        Restaurant sushiSpiritA = new Restaurant("Sushi Spirit", true, "23 Boulevard du Président Wilson, 06600 Antibes", "http://www.sushispirit.com", "0492909010", schedule1, 2.7, 20, new ArrayList<>(Arrays.asList(Tag.Japonais,Tag.Sushi)), new LatLng(43.568605, 7.112873), BitmapFactory.decodeResource(context.getResources(), R.drawable.sushispirit));
        ...
        Restaurant intermarch = new Restaurant("Intermarché", false, "Quartier Du Plan, 06270 Roquefort-les-Pins", "www.intermarche.com", " 0493770334", schedule1, 3.1, 10, new ArrayList<>(Arrays.asList(Tag.Francais, Tag.Healthy, Tag.Fromage)), new LatLng(43.669753, 7.047619), BitmapFactory.decodeResource(context.getResources(), R.drawable.interroquefort));
        Restaurant laBoucherie = new Restaurant("La Boucherie", true, "Parc de Sophia, 502 Rue Albert Caquot, 06560 Valbonne", "www.la-boucherie.fr", "0492384380", schedule1, 3.1, 15, new ArrayList<>(Arrays.asList(Tag.Viande, Tag.Francais, Tag.Burger, Tag.Fromage)), new LatLng(43.619850, 7.055750), BitmapFactory.decodeResource(context.getResources(), R.drawable.laboucherie));
        Restaurant boucherieLoufti = new Restaurant("Boucherie Chez Loufti", false, "1 Place de la Souste, 06560 Valbonne", "", "0493654871", schedule1, 2.3, 10, new ArrayList<>(Arrays.asList(Tag.Viande, Tag.Francais, Tag.Fromage)), new LatLng(43.622530, 7.046760), BitmapFactory.decodeResource(context.getResources(), R.drawable.loufti));
        Restaurant kingsGrill = new Restaurant("Kings Grill", true, "18 Rue Fourmillière, 06600 Antibes", "", "", schedule1, 1.7, 8, new ArrayList<>(Arrays.asList(Tag.Sandwich, Tag.Kebab, Tag.FastFood)), new LatLng(43.580170, 7.122880), BitmapFactory.decodeResource(context.getResources(), R.drawable.kingsgrill));
        Restaurant dejSoleil = new Restaurant("Déjeuner du Soleil", true, "1503 Route des Dolines, 06560 Valbonne", "http://www.dejeuner-desoleil.com", "0493958696", schedule1, 3.7, 8, new ArrayList<>(Arrays.asList(Tag.Crepe, Tag.Francais,Tag.Salade, Tag.Pizza, Tag.Italien, Tag.Glace)), new LatLng(43.616690, 7.039220), BitmapFactory.decodeResource(context.getResources(), R.drawable.dejsoleil));
        Restaurant flunch = new Restaurant("Flunch", true, "Chemin de Saint-Claude, 06600 Antibes", "restaurant.flunch.fr", "0493332399", schedule2, 3.1, 5, new ArrayList<>(Arrays.asList(Tag.Salade, Tag.Viande)), new LatLng(43.599340, 7.100710), BitmapFactory.decodeResource(context.getResources(), R.drawable.flucnh));
        ...
        Restaurant artdoise = new Restaurant("L'Artdoise Craie L'Histoire", true, "200 Avenue Roumanille Espace Saint Philippe Sophia Antipolis 06410 Biot", "www.lartdoise-craie-lhistoire.fr", "0492901088", schedule1, 4.7, 7, new ArrayList<>(Arrays.asList(Tag.Kebab,Tag.Sandwich, Tag.Pizza)), new LatLng(43.618070, 7.080440), BitmapFactory.decodeResource(context.getResources(), R.drawable.artdoise));
