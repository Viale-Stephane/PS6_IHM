...
public class OnlineController {
    ...
    public void init(Profile profile){
        ...
        this.profile.setOnMouseClicked(event -> researchBar.setText(this.model.accessingTo(true, leftPane, rightPane, profile,View.PROFILE,View.CSS_FILE,"ProfileController")));
        filterButton.setOnMouseClicked(event -> researchBar.setText(this.model.accessingTo(false, leftPane, rightPane, profile,View.MENU_FILTER,View.CSS_FILE,"ResearchRestaurantController")));
