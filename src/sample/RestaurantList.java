...
public class RestaurantList {
    ...
    public void sampleRestaurant(){
        ...
        Restaurant resto40 = new Restaurant("La Boucherie",true,"171 Avenue Jean Sébastien Bach, 06560 Valbonnes", "www.siteweb.com","042260123097",schedule,1.1,20,43,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Kebab, Tag.Japonais, Tag.Healthy)),imageLaBoucherie);
        Restaurant resto41 = new Restaurant("Quick",true,"179 Avenue Albert Cacot, 06410 Biot", "www.siteweb.com","042267783161",schedule,0.1,62,74,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Sandwich, Tag.Salade, Tag.Japonais)),imageQuick);
        ...
        Restaurant resto49 = new Restaurant("Leclerc",false,"36 avenue Weisweiller, Angle Route De Grasse, 06600 Antibes", "www.siteweb.com","042205072075",schedule,2.2,37,8,new ArrayList<Tag>(Arrays.asList(Tag.Burger,Tag.FastFood, Tag.Japonais, Tag.Crepe, Tag.Glace, Tag.Italien)),imageLeclerc);
