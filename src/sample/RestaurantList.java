...
public class RestaurantList {
    ...
    public void sampleRestaurant(){
        ...
        Restaurant resto3 = new Restaurant("MacDonald",true,"164 Boulevard Frederick Mistral, 06410 Biot", "www.siteweb.com","042219065546",schedule,1.3,90,14,new ArrayList<Tag>(Arrays.asList(  Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageMacdo);
        ...
        Restaurant resto5 = new Restaurant("Quick",true,"73 Avenue Frederick Mistral, 06000 Nice", "www.siteweb.com","042293089635",schedule,2.6,65,70,new ArrayList<Tag>(Arrays.asList(  Tag.Sandwich, Tag.Salade, Tag.Francais)),imageQuick);
        ...
        Restaurant resto14 = new Restaurant("Burger King",true,"97 Avenue St Barthélemy, 06560 Valbonnes", "www.siteweb.com","042255893848",schedule,0.7,84,66,new ArrayList<Tag>(Arrays.asList(  Tag.Kebab, Tag.Salade, Tag.Healthy)),imageBK);
        ...
        Restaurant resto16 = new Restaurant("Dragon D’or",true,"39 Boulevard Jean Sébastien Bach, 06150 Cannes", "www.siteweb.com","042292456727",schedule,1.4,98,48,new ArrayList<Tag>(Arrays.asList(  Tag.Chinois, Tag.Salade, Tag.Healthy)),imageDragonDor);
        Restaurant resto17 = new Restaurant("Hippopotamus",true,"12 Avenue General de Gaulle, 06150 Cannes", "www.siteweb.com","042287069679",schedule,3.0,94,86,new ArrayList<Tag>(Arrays.asList(  Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageHippopotamus);
        Restaurant resto18 = new Restaurant("La Boucherie",true,"66 Avenue Frederick Mistral, 06000 Nice", "www.siteweb.com","042243284353",schedule,4.4,68,74,new ArrayList<Tag>(Arrays.asList(  Tag.Japonais, Tag.Salade, Tag.Healthy)),imageLaBoucherie);
        Restaurant resto19 = new Restaurant("Flunch",true,"31 Avenue Frederick Mistral, 06560 Valbonnes", "www.siteweb.com","042293044462",schedule,1.6,97,42,new ArrayList<Tag>(Arrays.asList(  Tag.Japonais, Tag.Fromage, Tag.Healthy)),imageFlunch);
        ...
        Restaurant resto21 = new Restaurant("Quick",true,"93 Boulevard Frederick Mistral, 06000 Nice", "www.siteweb.com","042299326821",schedule,1.9,92,53,new ArrayList<Tag>(Arrays.asList(  Tag.Italien, Tag.Salade, Tag.Healthy)),imageQuick);
        ...
        Restaurant resto23 = new Restaurant("La Boucherie",true,"105 Boulevard Jean Sébastien Bach, 06560 Valbonnes", "www.siteweb.com","042220777930",schedule,0.9,86,84,new ArrayList<Tag>(Arrays.asList(  Tag.Sushi, Tag.Japonais, Tag.Healthy)),imageBiocoop);
        ...
        Restaurant resto31 = new Restaurant("Quick",true,"138 Boulevard Albert Cacot, 06600 Antibes", "www.siteweb.com","042230605667",schedule,0.4,36,79,new ArrayList<Tag>(Arrays.asList(  Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageQuick);
        ...
        Restaurant resto41 = new Restaurant("Quick",true,"179 Avenue Albert Cacot, 06410 Biot", "www.siteweb.com","042267783161",schedule,0.1,62,74,new ArrayList<Tag>(Arrays.asList(  Tag.Sandwich, Tag.Salade, Tag.Japonais)),imageQuick);
        ...
        Restaurant resto47 = new Restaurant("La Boucherie",true,"102 Boulevard General de Gaulle, 06150 Cannes", "www.siteweb.com","042268493561",schedule,2.3,9,53,new ArrayList<Tag>(Arrays.asList(  Tag.Sandwich, Tag.Pizza, Tag.Japonais)),imageLaBoucherie);
