...
public class RestaurantList {
    ...
    public void sampleRestaurant(){
        ...
        Restaurant resto4 = new Restaurant("Flunch",true,"66 Avenue St Barthélemy, 06000 Nice", "www.siteweb.com","042234911853",schedule,4.6,56,11,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageFlunch);
        Restaurant resto5 = new Restaurant("Quick",true,"73 Avenue Frederick Mistral, 06000 Nice", "www.siteweb.com","042293089635",schedule,2.6,65,70,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageQuick);
        Restaurant resto6 = new Restaurant("Casion",false,"48 Avenue Jean Sébastien Bach, 06600 Antibes", "www.siteweb.com","042287955030",schedule,4.8,30,25,new ArrayList<Tag>(Arrays.asList(Tag.Burger,Tag.FastFood)),imageCasino);
        Restaurant resto7 = new Restaurant("Leclerc",false,"151 Boulevard General de Gaulle, 06560 Valbonnes", "www.siteweb.com","042294949032",schedule,1.4,7,65,new ArrayList<Tag>(Arrays.asList(Tag.Burger,Tag.FastFood)),imageLeclerc);
        Restaurant resto8 = new Restaurant("Leclerc",false,"1 Avenue Jean Sébastien Bach, 06600 Antibes", "www.siteweb.com","042227966621",schedule,0.4,62,58,new ArrayList<Tag>(Arrays.asList(Tag.Burger,Tag.FastFood)),imageLeclerc);
        Restaurant resto9 = new Restaurant("Intermarché",false,"152 Boulevard Jean Sébastien Bach, 06150 Cannes", "www.siteweb.com","042217815796",schedule,0.6,45,5,new ArrayList<Tag>(Arrays.asList(Tag.Burger,Tag.FastFood)),imageIntermache);
        Restaurant resto10 = new Restaurant("LiDL",false,"141 Boulevard Jean Sébastien Bach, 06150 Cannes", "www.siteweb.com","042293369692",schedule,2.1,53,74,new ArrayList<Tag>(Arrays.asList(Tag.Burger,Tag.FastFood)),imageLidL);
        Restaurant resto11 = new Restaurant("Sushi Spirit",true,"168 Boulevard Frederick Mistral, 06560 Valbonnes", "www.siteweb.com","042246716108",schedule,3.0,31,64,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageSushiSpirit);
        ...
        Restaurant resto13 = new Restaurant("Hippopotamus",true,"31 Avenue St Barthélemy, 06150 Cannes", "www.siteweb.com","042224059671",schedule,1.3,51,5,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageHippopotamus);
        Restaurant resto14 = new Restaurant("Burger King",true,"97 Avenue St Barthélemy, 06560 Valbonnes", "www.siteweb.com","042255893848",schedule,0.7,84,66,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageBK);
        ...
        Restaurant resto16 = new Restaurant("Dragon D’or",true,"39 Boulevard Jean Sébastien Bach, 06150 Cannes", "www.siteweb.com","042292456727",schedule,1.4,98,48,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageDragonDor);
        ...
        Restaurant resto18 = new Restaurant("La Boucherie",true,"66 Avenue Frederick Mistral, 06000 Nice", "www.siteweb.com","042243284353",schedule,4.4,68,74,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageLaBoucherie);
        Restaurant resto19 = new Restaurant("Flunch",true,"31 Avenue Frederick Mistral, 06560 Valbonnes", "www.siteweb.com","042293044462",schedule,1.6,97,42,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageFlunch);
        ...
        Restaurant resto21 = new Restaurant("Quick",true,"93 Boulevard Frederick Mistral, 06000 Nice", "www.siteweb.com","042299326821",schedule,1.9,92,53,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageQuick);
        Restaurant resto22 = new Restaurant("Burger King",true,"154 Boulevard Albert Cacot, 06000 Nice", "www.siteweb.com","042290638866",schedule,1.2,29,19,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageBK);
        Restaurant resto23 = new Restaurant("La Boucherie",true,"105 Boulevard Jean Sébastien Bach, 06560 Valbonnes", "www.siteweb.com","042220777930",schedule,0.9,86,84,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageBiocoop);
        ...
        Restaurant resto29 = new Restaurant("O’Shushi",false,"46 Boulevard Frederick Mistral, 06150 Cannes", "www.siteweb.com","042236841707",schedule,4.8,16,56,new ArrayList<Tag>(Arrays.asList(Tag.Burger,Tag.FastFood)),imageOsushi);
        ...
        Restaurant resto32 = new Restaurant("NaturéO",false,"26 Boulevard General de Gaulle, 06000 Nice", "www.siteweb.com","042226072265",schedule,2.1,68,79,new ArrayList<Tag>(Arrays.asList(Tag.Burger,Tag.FastFood)),imageNatureo);
        ...
        Restaurant resto35 = new Restaurant("O’Shushi",false,"150 Boulevard Jean Sébastien Bach, 06150 Cannes", "www.siteweb.com","042242638301",schedule,2.0,65,15,new ArrayList<Tag>(Arrays.asList(Tag.Burger,Tag.FastFood)),imageOsushi);
        ...
        Restaurant resto38 = new Restaurant("Quick",true,"323 Avenue General de Gaulle, 06600 Antibes", "www.siteweb.com","042285386279",schedule,3.0,77,10,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageQuick);
        ...
        Restaurant resto40 = new Restaurant("La Boucherie",true,"171 Avenue Jean Sébastien Bach, 06560 Valbonnes", "www.siteweb.com","042260123097",schedule,1.1,20,43,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageLaBoucherie);
        ...
        Restaurant resto44 = new Restaurant("MacDonald",true,"94 Avenue Jean Sébastien Bach, 06600 Antibes", "www.siteweb.com","042247326593",schedule,4.3,57,81,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageMacdo);
        ...
        Restaurant resto47 = new Restaurant("La Boucherie",true,"102 Boulevard General de Gaulle, 06150 Cannes", "www.siteweb.com","042268493561",schedule,2.3,9,53,new ArrayList<Tag>(Arrays.asList(Tag.Commerce, Tag.Sandwich, Tag.Salade, Tag.Healthy)),imageLaBoucherie);
        Restaurant resto48 = new Restaurant("Casion",false,"108 Boulevard Frederick Mistral, 06000 Nice", "www.siteweb.com","042298515224",schedule,0.4,50,50,new ArrayList<Tag>(Arrays.asList(Tag.Burger,Tag.FastFood)),imageCasino);
